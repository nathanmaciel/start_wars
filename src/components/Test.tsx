...
export default function Test(){
    ...
    return(
        <React.Fragment>
             <Title>Test</Title>
             <Container></Container>
             <button onClick={() => dispatch(ACTIONS.LOGIN)}>Click me</button>
        </React.Fragment>
    )
}